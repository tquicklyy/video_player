...
public class InfoAboutPlayer {
    ...
    void initialize() {
        ...
        infoAboutPLayerSecondLabel.setText("""
                ...
                Программное средство 'KubSTU Education Video Player' разработано для просмотра пользователем\
                 своих видеороликов, а также обучающих видеоуроков по программированию\
